...
const List<_TransDef> _translations = [
  ...
  // ?????? Urdu ?????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
  (id:'ur.jalandhry',   name:'???????? ??? ????????????????',           author:'Fateh Muhammad Jalandhry',        rtl:true),
  (id:'ur.kanzuliman',  name:'???????? ??? ?????? ??????????????',        author:'Imam Ahmad Raza Khan',            rtl:true),
  (id:'ur.ahmedali',    name:'???????? ??? ???????? ??????',           author:'Shah Ahmed Ali',                  rtl:true),
  (id:'ur.maududi',     name:'???????? ??? ?????????? ????????????',       author:'Maulana Sayyid Abul Ala Maududi', rtl:true),
  // ?????? French ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
  (id:'fr.hamidullah',  name:'Fran??ais ??? Hamidullah',    author:'Muhammad Hamidullah',             rtl:false),
];
...
class _QuranScreenState extends State<QuranScreen> {
  ...
  static const _qTafsirEditions = [
    ...
    (id:'ur-tafseer-ibn-e-kaseer',  name:'?????? ???????? (????????)', emoji:'????', src:'cdn',   slug:'ur-tafseer-ibn-e-kaseer',   rtl:true),
    (id:'ur-tafsir-bayan-ul-quran', name:'???????? ????????????',     emoji:'????', src:'cdn',   slug:'ur-tafsir-bayan-ul-quran',  rtl:true),
  ];
  ...
  Future<void> _toggleFavourite() async {
    ...
    _showSnack(adding ? '?????? Added to Favourites' : 'Removed from Favourites');
  }
