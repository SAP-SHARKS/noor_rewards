...
void main() {
  ...
  for (int i = 0; i < lines.length; i++) {
    if (lines[i].contains('Unparalleled Scales')) {
      if (start == -1) start = i - 1; // get the comment above it
    }
    if (lines[i].contains('Sunrise Glory')) {
      end = i - 1; 
      break;
    }
  }
  ...
  if (start > 0 && end > start) {
    ...
    final finalContent = [...before, ...newLines, ...after];
    file.writeAsBytesSync(utf8.encode(finalContent.join('\n')));
    print('Successfully written!');
  } else {
    print('Could not find boundaries! start:$start end:$end');
  }
}
