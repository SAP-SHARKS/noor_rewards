...
const FEATURE_FLAGS = [
  ...
  { key: "show_quran_engagement", label: "Quran Engagement Strip", desc: "Show the 'reading right now / frequently read by community' card on the Quran Hub. Off = hide the whole card." },
