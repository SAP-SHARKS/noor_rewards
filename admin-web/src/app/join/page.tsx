                ...
                <div className="flex flex-col gap-5 relative z-10">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[#5C543A] mt-1.5 leading-relaxed font-medium">
                        Both you and the inviter receive a <span className="font-bold text-[#D89A1E]">500 Seeds bonus</span> the instant you join!
                      </p>
                    </div>
                  </div>

                  {/* Code and Copy action row */}
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 bg-white border border-[#D89A1E]/20 p-2.5 rounded-2xl shadow-inner w-full">
