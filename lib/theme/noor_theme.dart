...
class NoorTheme {
  ...
  Color get border        => _isLight ? const Color(0xFFE8E8EC) : const Color(0xFF374151);
  Color get card          => _isLight ? Colors.white : const Color(0xFF1F2937);
  Color get darkBtn       => _isLight ? const Color(0xFF1C1C1E) : const Color(0xFF374151);
  Color get inputFill     => _isLight ? const Color(0xFFF2F2F7) : const Color(0xFF1F2937);
