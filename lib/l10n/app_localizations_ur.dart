...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get lightOfMercy => 'نور الرحمۃ';

  @override
  String get noorRewards => 'نور ریواردز';
  ...
  String get onboarding1Subtitle =>
      'نور ریواردز میں خوش آمدید — جہاں ہر نیک عمل آپ کو اللہ کی رحمت اور نور کے قریب لاتا ہے۔';
  ...
  String get onboarding2Subtitle =>
      'آپ کا پڑھا ہوا ہر لفظ آپ کو ثواب دیتا ہے — آخرت میں نور۔\nآپ کے نور سکے حقیقی مقاصد کو فنڈ کرتے ہیں۔';
  ...
  @override
  String get earnNoorPoints => 'نور پوائنٹس کمائیں';

  @override
  String get yourProgress => 'آپ کی پیشرفت';

  @override
  String get yourTotalNoorPoints => 'آپ کے کل نور پوائنٹس';
  ...
  @override
  String get noorPoints => 'نور پوائنٹس';
  ...
  String get yourNoorPointsFundProjects =>
      'آپ کے نور پوائنٹس ان منصوبوں کو فنڈ کرتے ہیں';

  @override
  String get youBothEarnPoints => 'آپ دونوں 500 نور پوائنٹس کمائیں گے!';
  ...
  String get donatePointsToSupport =>
      'حقیقی منصوبوں کی حمایت کے لیے اپنے نور پوائنٹس عطیہ کریں';
  ...
  String ptsToLevel(String pts, String level) {
    return '$pts پوائنٹس سطح $level تک';
  }
  ...
  String get startEarningPts =>
      'پوائنٹس کمانا شروع کریں — قرآن پڑھیں، ذکر اور دعا کریں۔';

  @override
  String get howToEarnPts => 'پوائنٹس کیسے کمائیں';
  ...
  String ptsBoost(String multiplier) {
    return '$multiplier× پوائنٹس بوسٹ';
  }
  ...
  @override
  String get earnPointsTafsir => 'ہر 10 منٹ تفسیر سننے پر پوائنٹس کمائیں';
  ...
  @override
  String get showPointsBanner => 'پوائنٹس بینر دکھائیں';

  @override
  String get noorPointsNotificationStrip => '+نور پوائنٹس نوٹیفکیشن پٹی';
  ...
  @override
  String get earnPointsPerVerse => 'ہر آیت پڑھنے پر +10 نور پوائنٹس کمائیں';
  ...
  String get dailyAzkarBonusMsg =>
      'ماشاء اللہ! آپ نے اپنے روزانہ اذکار مکمل کیے اور بونس +50 نور پوائنٹس کمائے۔';
  ...
  @override
  String get recordedInBookOfDeeds => 'آپ کے نامہ اعمال میں درج';
  ...
  @override
  String get pointsDonatedToCommunity => 'برادری کو عطیہ کیے گئے پوائنٹس';
  ...
  @override
  String get noorPointsSummary => 'نور پوائنٹس کا خلاصہ';

  @override
  String get totalPoints => 'کل پوائنٹس';
  ...
  String yourAvailable(String pts) {
    return 'آپ کے دستیاب: $pts پوائنٹس';
  }

  @override
  String jazakAllahDonated(String pts) {
    return 'جزاک اللہ! $pts پوائنٹس عطیہ کیے گئے';
  }
  ...
  @override
  String get noPointsAvailable => 'کوئی پوائنٹس دستیاب نہیں';
  ...
  @override
  String get aboutNoorRewards => 'نور ریواردز کے بارے میں';
  ...
  String get aboutBody =>
      'عالمی مسلم امت کے لیے محبت سے بنایا گیا۔\nاسلامی عادات بنا کر نور پوائنٹس کمائیں۔\nحقیقی برادری کے منصوبوں کی حمایت کے لیے پوائنٹس عطیہ کریں۔';

  @override
  String get howToEarnQuestion => 'نور پوائنٹس کیسے کمائیں؟';

  @override
  String get howToEarnAnswer =>
      'پوائنٹس کمانے کے لیے قرآن پڑھیں، ذکر کریں اور روزانہ لاگ ان کریں۔';
  ...
  @override
  String get canDonatQuestion => 'کیا میں اپنے نور پوائنٹس عطیہ کر سکتا ہوں؟';

  @override
  String get canDonateAnswer =>
      'ہاں! فعال برادری کے منصوبوں کو اپنے پوائنٹس عطیہ کرنے کے لیے آخرت ٹیب پر جائیں۔';
  ...
  @override
  String get earnMoreNoor => 'مزید نور کمائیں';
  ...
  @override
  String get completeNowBonus => 'ابھی مکمل کریں ← +50 پوائنٹس بونس کمائیں';
  ...
  String get finishAzkaarBonus =>
      'اپنے اذکار مکمل کریں ← +30 پوائنٹس بونس کمائیں';

  @override
  String get inviteAFriend => 'ایک دوست کو مدعو کریں';

  @override
  String get shareNoorBonus => 'کسی کے ساتھ نور شیئر کریں ← +100 NP کمائیں';

  @override
  String get multiplyYour => 'اپنے';

  @override
  String get noorPointsBang => 'نور پوائنٹس بڑھائیں!';

  @override
  String get keepMomentum =>
      'اپنی روحانی رفتار جاری رکھیں\nاور اپنے نور کو بڑھتے دیکھیں';
  ...
  @override
  String get earnSawabWithRead => 'ہر پڑھائی سے\nثواب کمائیں';

  @override
  String get realImpact => 'حقیقی اثر';

  @override
  String get coinsFundCauses => 'سکے نیک\nمقاصد کو فنڈ کرتے ہیں';
  ...
  @override
  String get noorPointsBloomed => 'نور پوائنٹس کھل گئے';
  ...
  String get fundProjectsText =>
      'آپ کے نور پوائنٹس ان منصوبوں کی مالی اعانت کرتے ہیں';
