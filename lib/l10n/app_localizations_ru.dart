...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get onboarding1Subtitle =>
      'Добро пожаловать в Noor Rewards — где каждое доброе дело приближает вас к милости и свету Аллаха.';
  ...
  String get onboarding2Subtitle =>
      'Каждое прочитанное слово приносит вам Саваб — свет в вашей Ахира.\nВаши Noor Coin финансируют реальные дела, меняющие реальные жизни.';
  ...
  @override
  String get earnNoorPoints => 'ЗАРАБАТЫВАЙТЕ ОЧКИ НУР';

  @override
  String get yourProgress => 'ВАШ ПРОГРЕСС';

  @override
  String get yourTotalNoorPoints => 'ВСЕГО ОЧКОВ НУР';
  ...
  @override
  String get noorPoints => 'Очки Нур';
  ...
  @override
  String get topContributors => 'Лучшие участники по общему количеству очков';
  ...
  String get yourNoorPointsFundProjects =>
      'Ваши очки Нур финансируют эти проекты';

  @override
  String get youBothEarnPoints => 'Вы оба получите 500 очков Нур!';
  ...
  String get donatePointsToSupport =>
      'Пожертвуйте очки Нур на поддержку реальных проектов';
  ...
  String ptsToLevel(String pts, String level) {
    return '$pts очк. до уровня $level';
  }
  ...
  String get startEarningPts =>
      'Начните зарабатывать очки — читайте Коран, делайте зикр и дуа.';

  @override
  String get howToEarnPts => 'Как заработать очки';
  ...
  @override
  String get nextMilestone => 'СЛЕДУЮЩАЯ ЦЕЛЬ';

  @override
  String get allMilestones => 'ВСЕ ЦЕЛИ';
  ...
  String get earnPointsTafsir =>
      'Зарабатывайте очки за каждые 10 минут прослушивания тафсира';
  ...
  @override
  String get showPointsBanner => 'Показать баннер очков';

  @override
  String get noorPointsNotificationStrip => 'Уведомление +Очки Нур';
  ...
  String get earnPointsPerVerse =>
      'Зарабатывайте +10 очков Нур за каждый прочитанный аят';
  ...
  String get dailyAzkarBonusMsg =>
      'Маша Аллах! Вы выполнили ежедневные азкары и заработали бонус +50 очков Нур.';
  ...
  @override
  String get pointsDonatedToCommunity => 'Очки пожертвованы сообществу';
  ...
  @override
  String get noorPointsSummary => 'Сводка очков Нур';
  ...
  String yourAvailable(String pts) {
    return 'Доступно: $pts очк.';
  }

  @override
  String jazakAllahDonated(String pts) {
    return 'ДжазакАллах! $pts очк. пожертвовано';
  }
  ...
  @override
  String get noPointsAvailable => 'Нет доступных очков';
  ...
  @override
  String get aboutNoorRewards => 'О Noor Rewards';
  ...
  String get aboutBody =>
      'Создано с любовью для мусульманской Уммы.\nЗарабатывайте очки Нур, развивая исламские привычки.\nЖертвуйте очки на поддержку реальных проектов сообщества.';

  @override
  String get howToEarnQuestion => 'Как заработать очки Нур?';

  @override
  String get howToEarnAnswer =>
      'Читайте Коран, делайте зикр и входите ежедневно, чтобы зарабатывать очки.';
  ...
  @override
  String get canDonatQuestion => 'Могу ли я пожертвовать очки Нур?';

  @override
  String get canDonateAnswer =>
      'Да! Перейдите на вкладку «Ахира», чтобы пожертвовать очки на активные проекты сообщества.';
  ...
  @override
  String get earnMoreNoor => 'Заработать больше Нур';
  ...
  @override
  String get completeNowBonus => 'Завершите сейчас → получите бонус +50 очков';

  @override
  String get completeADhikrSet => 'Завершить подход зикра';

  @override
  String get finishAzkaarBonus => 'Завершите азкары → получите бонус +30 очков';

  @override
  String get inviteAFriend => 'Пригласить друга';

  @override
  String get shareNoorBonus => 'Поделитесь Нуром → получите +100 очков';

  @override
  String get multiplyYour => 'УМНОЖЬТЕ СВОИ';

  @override
  String get noorPointsBang => 'ОЧКИ НУР!';

  @override
  String get keepMomentum =>
      'Поддерживайте духовный настрой\nи наблюдайте, как растёт ваш Нур';
  ...
  @override
  String get earnSawabWithRead => 'Зарабатывайте саваб\nс каждым чтением';

  @override
  String get realImpact => 'Реальное влияние';

  @override
  String get coinsFundCauses => 'Монеты финансируют\nблагие дела';
