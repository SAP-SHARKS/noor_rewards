  ...
  (
    ...
    style:
        (size, color, height, weight) => TextStyle(
          ...
          wordSpacing:
              -3.5, // Brings words together closely to match Quranly style
        ),
  ),
];
...
class _QuranScreenState extends State<QuranScreen> with WidgetsBindingObserver {
  ...
  DoubleTapGestureRecognizer _getMushafRecognizer(int surahNum, int ayahNum) {
    ...
    return _mushafAyahRecognizers.putIfAbsent(
      key,
      () =>
  ...
  Future<void> _init() async {
    ...
    if (_fullPageMode) {
      ...
      final savedPage =
          _cache.get('pref_mushaf_page', defaultValue: _currentPage) as int;
      final savedSurah =
          _cache.get('pref_mushaf_surah', defaultValue: _surah) as int;
      final savedAyah =
          _cache.get('pref_mushaf_ayah', defaultValue: _ayah) as int;
  ...
  Future<void> _fetchAyah(int surah, int ayah) async {
    ...
    final cacheKey =
        '$surah:$ayah:$_translationEdition:$recEdition:$scriptSlug';
    ...
    if (cached != null) {
      ...
      if (cachedAt != null &&
          ...
          transOk) {
        setState(() {
          _arabic = _QuranScreenState._stripQuranicAnnotations(
            cached['arabic'] ?? '',
          );
    ...
    try {
      ...
      final arabicMap = await QuranApiService.instance.surahScript(
        surah: surah,
      ...
      for (int a = 1; a <= _surahLengths[surah]; a++) {
        ...
        await _cache.put(cKey, {
          ...
          'trans': transMap[vId] ?? '',
          'audio':
              'https://cdn.islamic.network/quran/audio/$recBitrate/$recEdition/$vId.mp3',
          'surahName': sName,
          'ts': nowStr,
        });
      }
  ...
  Future<void> _nextAyah({bool fromAutoPlay = false}) async {
    ...
    final nextSurah =
        _ayah < maxAyah ? _surah : (_surah < 114 ? _surah + 1 : 1);
  ...
  Future<void> _saveReadingProgress(
    ...
    try {
      if (earnRewards) {
        ...
        await _sb.rpc(
          'earn_quran_points',
          params: {'p_surah': s, 'p_ayah': a, 'p_coins': coins},
        );
  ...
  Future<void> _fetchMushafTranslations(
  ...
  Future<int> _resolvePageForCurrentAyah() async {
    ...
    try {
      final url =
          'https://api.quran.com/api/v4/verses/by_key/$_surah:$_ayah'
          '?fields=page_number';
                          ...
                          itemBuilder: (_, i) {
                            ...
                            return ListTile(
                              onTap: () {
                                ...
                                _currentPage =
                                    _kSurahStartPage[n.clamp(1, 114)];
                                _syncReadingPosition();
                                _savePagePosition();
                              },
                              leading: Container(
          ...
          Padding(
            ...
            child: Text(
              ...
              style:
                  isUrdu
                      ? GoogleFonts.amiri(
                        fontSize: _translationFontSize + 6,
                        fontWeight: FontWeight.w700,
                        color: txt,
                        height: 1.5,
                      )
      ...
      spans.add(
        TextSpan(
          ...
          style: GoogleFonts.amiri(
            fontSize: _translationFontSize + 4,
            fontWeight: FontWeight.w700,
            color: txt,
            height: 1.9,
          ),
  ...
  // ── Inline Tafsir ────────────────────────────────────────────────────────────
  Future<void> _fetchTafsirText({
    required int editionIdx,
                          ...
                          child: Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<int>(
                                ...
                                items: List.generate(_qTafsirEditions.length, (
                                  i,
                                ) {
                                ...
                                (_, __, ___) => ListView(
                                  ...
                                  children: [
                                    if (_tafsirLoading)
                                      ...
                                      () {
                                        final def =
                                            _qTafsirEditions[_tafsirEditionIdx];
                                        return _buildFormattedTafsir(
                                          _tafsirText,
                                          lblC,
                                          subC,
                                          isUrdu: def.rtl,
  ...
  Future<void> _togglePlay() async {
    if (_audioUrl == null || _audioUrl!.isEmpty) {
      _showSnack(
        AppLocalizations.of(context)?.audioNotLoaded ??
  ...
  Future<void> _toggleFavourite() async {
    ...
    if (uid == null) {
      _showSnack(
        AppLocalizations.of(context)?.signInToSaveFavourites ??
            ...
            builder: (ctx, setSt) {
              ...
              Widget sTile(
                ...
                return Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: _darkMode ? const Color(0xFF2C2C2E) : _kBg,
                      borderRadius: BorderRadius.circular(16),
                    ),
                    child: SwitchListTile(
                      ...
                      title: Text(
                        ...
                        style: GoogleFonts.outfit(
                          fontSize: 14,
                          fontWeight: FontWeight.w700,
                          color: _darkMode ? Colors.white : _kText,
                        ),
                      ),
                      subtitle: Text(
                        s,
              ...
              final bgC = _darkMode ? _kText : Colors.white;
              final lblC = _darkMode ? Colors.white : _kText;
              return DraggableScrollableSheet(
                            ...
                            child: ListView(
                              ...
                              children: [
                                ...
                                sTile(
                                  ...
                                  AppLocalizations.of(context)?.focusModeDesc ??
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Slider(
                                          ...
                                          divisions: 12,
                                          activeColor: _accent,
                                          inactiveColor: _accent.withValues(
                                            alpha: 0.2,
                                          ),
                                          onChanged: (v) {
                                            final tFs =
                                ...
                                // ═ QURAN SCRIPT
                                sHead(
                                  AppLocalizations.of(context)?.quranScript ??
                                      'QURAN SCRIPT',
                                  Icons.draw_rounded,
                                ),
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  _kQuranScripts[_quranScriptIdx]
                                                      .name,
                                                  style: GoogleFonts.outfit(
                                                    fontSize: 11,
                                                    color: const Color(
                                        ...
                                        const SizedBox(height: 16),
                                        ...List.generate(_kQuranScripts.length, (
                                          i,
                                        ) {
                                ...
                                // ═ READING LAYOUT
                                sHead(
                                  AppLocalizations.of(context)?.readingLayout ??
                                      'READING LAYOUT',
                                ...
                                sTile(
                                  AppLocalizations.of(context)?.autoAdvance ??
                                      'Auto-Advance',
                                  AppLocalizations.of(
                                        context,
                                      )?.moveToNextVerse ??
                                ...
                                sTile(
                                  ...
                                  AppLocalizations.of(context)?.loopAyahAudio ??
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 14),
                                        ...List.generate(_translations.length, (
                                          i,
                                        ) {
                                          final t = _translations[i];
                                          final sel =
                                              t.id == _translationEdition;
                                          // Language flag emoji
                                          final String flag;
                                          if (t.id.startsWith('en.')) {
                                            flag = '🇬🇧';
                                          } else if (t.id.startsWith('ur.')) {
                                            flag = '🇵🇰';
                                          } else if (t.id.startsWith('fr.')) {
                                            flag = '🇫🇷';
                                          } else if (t.id.startsWith('tr.')) {
                                            flag = '🇹🇷';
                                          } else if (t.id.startsWith('id.')) {
                                            flag = '🇮🇩';
                                          } else if (t.id.startsWith('bn.')) {
                                            flag = '🇧🇩';
                                          } else if (t.id.startsWith('de.')) {
                                            flag = '🇩🇪';
                                          } else if (t.id.startsWith('es.')) {
                                            flag = '🇪🇸';
                                          } else {
                                            flag = '🌐';
                                          }
                                          return GestureDetector(
                                            onTap: () async {
                                              ...
                                              for (
                                                int a = 1;
                                                a <= _surahLengths[_surah];
                                                a++
                                              ) {
                                                final ck =
                                                    '$_surah:$a:$newEdition:${_reciters[_reciterIdx].$1}';
  ...
  Widget _buildAudioPlayer() {
    ...
    final sliderVal =
        _dur.inMilliseconds > 0
            ? _pos.inMilliseconds.toDouble().clamp(
              0.0,
              _dur.inMilliseconds.toDouble(),
            )
            : 0.0;
    final sliderMax =
        _dur.inMilliseconds > 0 ? _dur.inMilliseconds.toDouble() : 1.0;
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                AppLocalizations.of(context)?.reciterLabel ?? 'Reciter:',
                style: GoogleFonts.outfit(
                  fontSize: 11,
                  fontWeight: FontWeight.w600,
                  color:
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: List.generate(_reciters.length, (i) {
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          margin: EdgeInsets.only(
                            right: i < _reciters.length - 1 ? 6 : 0,
                          ),
                          padding: const EdgeInsets.symmetric(
                            horizontal: 12,
                            vertical: 5,
            ...
            children: [
              IconButton(
                ...
                icon: Icon(
                  ...
                  size: 26,
                  color: hasAudio ? _accent : Colors.grey.shade300,
                ),
                  ...
                  child:
                      _audioLoading
                          ...
                          : Icon(
                            ...
                            color:
                                hasAudio ? Colors.white : Colors.grey.shade400,
                            size: 26,
                          ),
                ),
              ),
                  ...
                  IconButton(
                    icon: AnimatedSwitcher(
                      ...
                      child: Icon(
                        ...
                        color: _isFavourited ? const Color(0xFFCC6600) : sub,
                        size: 24,
                      ),
                    ),
                    onPressed: _toggleFavourite,
                    tooltip:
                        AppLocalizations.of(context)?.favourite ?? 'Favourite',
                  ),
                  IconButton(
                    icon: AnimatedSwitcher(
                      duration: const Duration(milliseconds: 200),
                      child: Icon(
                        ...
                        color: _isBookmarked ? _kGold : sub,
                        size: 24,
                      ),
                    ),
      ...
      children: [
        Column(
          children: [
                            ...
                            Wrap(
                              ...
                              children: [
                                ...
                                _PillButton(
                                  ...
                                  onTap: () async {
                                    final page =
                                        await _resolvePageForCurrentAyah();
                                    await _player.stop();
                                    setState(() {
                                      ...
                                      TextSpan(
                                        text:
                                            _ayah == 1 &&
                                                ...
                                                : '$_arabic ',
                                        style: _kQuranScripts[_quranScriptIdx]
                                            .style(
                                              _arabicFontSize,
                                              txt,
                                              1.85,
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                AppLocalizations.of(context)?.goalAyahs ??
                                    'Goal: 50 ayahs/day',
                                style: GoogleFonts.outfit(
                                  fontSize: 11,
                                  color: sub,
            ...
            // Nav row
            if (!_fullScreenMode) _buildInlineNavRow(barBg: barBg, txt: txt),
          ],
        ),
                ...
                child: Row(
                  children: [
                    _fsFab(
                      ...
                      onTap: () => setState(() => _fullScreenMode = false),
                    ),
                    const Spacer(),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:
                              (_fullPageMode && _currentPage >= 604)
                    ...
                    const Spacer(),
                    _fsFab(icon: Icons.tune_rounded, onTap: _openSettings),
                  ],
                ),
              ),
            ),
    ...
    return LayoutBuilder(
      builder: (ctx, constraints) {
        ...
        for (int i = 0; i < _wbwWords.length; i += cols) {
          final rowWords = _wbwWords.sublist(
            i,
            (i + cols).clamp(0, _wbwWords.length),
          );
          // RTL: words go right→left, so reverse the row
          final rowWidgets =
              rowWords.reversed.map((w) {
                final isIndopak =
                    _kQuranScripts[_quranScriptIdx].apiSlug == 'indopak';
                final arStr =
                    isIndopak
                        ? (w['arabic_indopak'] ?? w['arabic'])
                        : w['arabic'];
                return SizedBox(
                  width: cardW,
                  child: _WbwWordChip(
                    arabic: _QuranScreenState._stripQuranicAnnotations(
                      arStr?.toString() ?? '',
                    ),
              ...
              children:
                  rowWidgets
                      .expand(
                        (w) => [
                          w,
                          if (w != rowWidgets.last) const SizedBox(width: hGap),
                        ],
                      )
                      .toList(),
            ),
          ...
          Expanded(
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                disabledBackgroundColor: (_darkMode
                        ? const Color(0xFF3A3A3C)
                        : const Color(0xFF636366))
  ...
  Widget _buildMushafPageFlipView(Color textClr, Color goldClr, Color pageBg) {
    return PageView.builder(
      ...
      itemBuilder: (context, index) {
        final pageNum = index + 1;
        // Lazy-load page data
        if (!_loadedPages.containsKey(pageNum) &&
    ...
    return Builder(
      builder: (ctx) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          if (offset < screenH * 0.5 &&
              offset + ro.size.height > screenH * 0.3) {
  ...
  Widget _buildMushafPageBlock(
    ...
    if (ayahs.isEmpty) {
      return Center(
        child: SizedBox(
          ...
          height: 24,
          child: CircularProgressIndicator(
            color: goldClr.withValues(alpha: 0.5),
            strokeWidth: 1.8,
          ),
        ),
      );
    ...
    void flushGroup() {
      ...
      blocks.add(
        _buildMushafTextBlock(currentGroup, textClr, goldClr, isIndoPak),
      );
      currentGroup.clear();
    }
    ...
    for (final ayah in ayahs) {
      ...
      if (lastSurah != surahKey) {
        ...
        if (ayahNum == 1 && surahNum >= 1) {
          ...
          blocks.add(
            _buildMushafSurahBanner(surahNum, goldClr, textClr, isIndoPak),
          );
          if (surahNum == 1) {
      ...
      final rawText =
          (isIndoPak
                  ? (ayah['arabic_indopak'] ?? ayah['arabic'])
                  : ayah['arabic'])
              as String? ??
          '';
  ...
  Widget _buildMushafTextBlock(
    ...
    for (int i = 0; i < ayahs.length; i++) {
      final a = ayahs[i];
      final text = _stripQuranicAnnotations(
        a['arabic_display'] as String? ?? '',
      );
      final ayahNum = a['ayah'] as int? ?? (i + 1);
      final numStr = ayahNum
          .toString()
          .split('')
          .map((e) => '٠١٢٣٤٥٦٧٨٩'[int.parse(e)])
          .join('');
    ...
    final baseStyle = _kQuranScripts[_quranScriptIdx].style(
      fontSize,
      textClr,
      lh,
      FontWeight.w400,
    ...
    return Column(
      children:
          ayahs.map((a) {
            ...
            final arabicText = _stripQuranicAnnotations(
              a['arabic_display'] as String? ?? '',
            );
                      ...
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            ...
                            style: _kQuranScripts[_quranScriptIdx]
                                .style(arabicSize, textClr, lh, FontWeight.w400)
  ...
  static String _stripQuranicAnnotations(String s) => s.replaceAll(
    RegExp(
      r'[\u0615-\u061A\u06D6-\u06DE\u06DF-\u06E4\u06E7-\u06E8\u06EA-\u06ED\u08D4-\u08FE\u200B\uE000-\uF8FF]',
    ),
    '',
      ...
      child: Stack(
        ...
        children: [
          ...
          for (final pos in [
            ...
            Positioned(
              top:
                  pos == Alignment.topLeft || pos == Alignment.topRight
                      ? 4
                      : null,
              bottom:
                  pos == Alignment.bottomLeft || pos == Alignment.bottomRight
                      ? 4
                      : null,
              left:
                  pos == Alignment.topLeft || pos == Alignment.bottomLeft
                      ? 6
                      : null,
              right:
                  pos == Alignment.topRight || pos == Alignment.bottomRight
                      ? 6
                      : null,
              child: Text(
                '❋',
          ...
          Padding(
            ...
            child: Text(
              ...
              textDirection: TextDirection.rtl,
              style: _kQuranScripts[_quranScriptIdx]
                  .style(18.0, goldClr, null, FontWeight.w700)
  ...
  Widget _buildMushafOverlay(Color overlayBg, Color goldClr, Color textClr) {
    ...
    BoxDecoration pillDecor() => BoxDecoration(
      color:
          isDark
              ? honeyBrown.withValues(alpha: 0.95)
              : honeyWarm.withValues(alpha: 0.95),
      borderRadius: BorderRadius.circular(14),
      border: Border.all(color: honeyGold.withValues(alpha: 0.30)),
      boxShadow: [
        BoxShadow(
          color: honeyBrown.withValues(alpha: 0.4),
          blurRadius: 12,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Page $_currentPage  ·  Juz ${_juzForPage(_currentPage)}',
                      style: GoogleFonts.outfit(
                        fontSize: 11,
                        fontWeight: FontWeight.w500,
        ...
        Container(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: honeyBrown.withValues(alpha: 0.5),
                  blurRadius: 16,
                  offset: const Offset(0, 4),
                ),
              ],
  ...
  void _openMushafSettings() {
    ...
    final chipBg =
        _darkMode ? Colors.white.withValues(alpha: 0.08) : Colors.grey.shade100;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                        AppLocalizations.of(context)?.mushafSettings ??
                            'Mushaf Settings',
                        style: GoogleFonts.outfit(
                          fontSize: 18,
                          fontWeight: FontWeight.w800,
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: optionChip(
                            AppLocalizations.of(context)?.scroll ?? 'Scroll',
                        ...
                        Expanded(
                          child: optionChip(
                            AppLocalizations.of(context)?.pageFlip ??
                                'Page Flip',
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: optionChip(
                            AppLocalizations.of(context)?.splitView ??
                                'Split View',
                    ...
                    // ── Script ──
                    sectionLabel(
                      AppLocalizations.of(context)?.script ?? 'SCRIPT',
                    ),
                    Row(
                      children: List.generate(_kQuranScripts.length, (i) {
                        final script = _kQuranScripts[i];
                        final active = i == _quranScriptIdx;
                        return Expanded(
                          child: Padding(
                            padding: EdgeInsets.only(
                              right: i < _kQuranScripts.length - 1 ? 10 : 0,
                            ),
                            child: GestureDetector(
                              onTap: () {
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    Text(
                                      script.arabicPreview,
                                      textDirection: TextDirection.rtl,
                                      style: script.style(
                                        18,
                                        active ? _accent : txtClr,
                                        null,
                                        FontWeight.w400,
                                      ),
                                    ),
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            setModalState(
                              () =>
                                  _mushafFontSize = (_mushafFontSize - 2).clamp(
                                    16.0,
                                    48.0,
                                  ),
                            );
                    ...
                    // ── Quick Actions ──
                    sectionLabel(
                      AppLocalizations.of(context)?.actionsLabel ?? 'ACTIONS',
                    ),
                    Row(
                      children: [
                        Expanded(
...
class _PillButtonState extends State<_PillButton>
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor =
        widget.active ? widget.activeColor.withValues(alpha: 0.14) : inactBg;
    final borderColor =
        widget.active
