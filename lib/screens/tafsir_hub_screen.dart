...
Color get _kSub =>
    _thcfg.dashBg.computeLuminance() > 0.5
...
class _TafsirHubScreenState extends State<TafsirHubScreen> {
  ...
  void _openTafsir({int surah = 1, int ayah = 1}) {
    Navigator.of(context, rootNavigator: true).push(
      MaterialPageRoute(
        builder: (_) => TafsirScreen(initialSurah: surah, initialAyah: ayah),
      ),
    );
  }
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            AppLocalizations.of(context)?.readListenTafsir ??
                                'Read & Listen Tafsir',
                          ...
                          Text(
                            AppLocalizations.of(context)?.deepUnderstanding ??
                ...
                children: [
                  ...
                  if (!_loadingProgress) ...[
                    _ResumeCard(
                      ...
                      ayah: _lastAyah,
                      onTap:
                          () => _openTafsir(surah: _lastSurah, ayah: _lastAyah),
                    ),
                  ...
                  // ── Featured surahs ─────────────────────────────────────────
                  Text(
                    AppLocalizations.of(context)?.featuredSurahs ??
                        'Featured Surahs',
                    style: GoogleFonts.outfit(
                      fontSize: 18,
                      fontWeight: FontWeight.w800,
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            AppLocalizations.of(context)?.browseAll114 ??
