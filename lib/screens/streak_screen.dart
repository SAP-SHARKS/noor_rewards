        ...
        children: [
          ...
          Positioned.fill(
            child: AnimatedBuilder(
              ...
              builder:
                  (_, __) =>
                      CustomPaint(painter: _AuraPainter(phase: _orbCtrl.value)),
            ),
          ),
...
class _AuraPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(_AuraPainter o) => o.phase != phase;
}
...
class _DotRow extends StatelessWidget {
  ...
  bool _active(StreakType t) => snap
      .historyFor(t)
      .any(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow:
                    on
                        ? [
                          BoxShadow(
                            color: _col(t).withValues(alpha: 0.35),
                            blurRadius: 6,
                          ),
                        ]
                        : [],
