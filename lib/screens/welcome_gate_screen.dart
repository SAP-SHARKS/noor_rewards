                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Row(
                              ...
                              children: [
                                Text(
                                  AppLocalizations.of(context)!.enterTheGarden,
                                  style: GoogleFonts.outfit(
                                    fontSize: 17,
...
class _MasjidGatePainter extends CustomPainter {
  ...
  void _drawMinaret(Canvas canvas, Offset top, double width, double bottom) {
    final r = Rect.fromCenter(
      center: Offset(top.dx, (top.dy + bottom) / 2),
      width: width,
    ...
    final tipPath =
        Path()
          ...
          ..lineTo(top.dx, top.dy - width * 1.4)
          ..close();
    canvas.drawPath(
      tipPath,
    ...
    canvas.drawRect(
      Rect.fromCenter(
        center: Offset(top.dx, top.dy + (bottom - top.dy) * 0.25),
        width: width * 1.5,
        height: 4,
      ),
  ...
  void _drawArch(Canvas canvas, Size size) {
    ...
    final path =
        Path()
          ...
          ..arcToPoint(
            Offset(cx, archTop - r * 0.3),
            radius: Radius.circular(r),
            clockwise: false,
          )
          ..arcToPoint(
            Offset(archRight, archTop + r),
            radius: Radius.circular(r),
            clockwise: false,
          )
    ...
    final glowPaint =
        Paint()
          ..shader = RadialGradient(
            ...
            Rect.fromLTWH(archLeft, archTop, w, archBottom - archTop),
          );
  ...
  void _drawSmallArch(Canvas canvas, Offset centre, double width) {
    ...
    final path =
        Path()
          ...
          ..arcToPoint(
            Offset(centre.dx, top - r * 0.2),
            radius: Radius.circular(r),
            clockwise: false,
          )
          ..arcToPoint(
            Offset(centre.dx + r, top + r),
            radius: Radius.circular(r),
            clockwise: false,
          )
  ...
  void _drawCrescent(Canvas canvas, Offset centre) {
    ...
    canvas.drawCircle(
      Offset(centre.dx + r * 0.55, centre.dy - r * 0.1),
      r * 0.82,
